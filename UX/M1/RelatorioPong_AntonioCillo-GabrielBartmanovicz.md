...
Dinâmica: A interação entre os jogadores, que precisam prever a trajetória da bola e se posicionar corretamente.

Estética: O minimalismo visual, que facilita a compreensão do jogo e aumenta sua acessibilidade.

Além disso, a velocidade variável da bola dependendo do ângulo de rebote do jogador adiciona mais um elemento de desafio e habilidade ao jogo, tornando-o mais dinâmico e imprevisível, oferecendo diferentes níveis de dificuldade a depender da habilidade do jogador.
...
Explosões e efeitos visuais para reforçar a ideia de destruição. Ícones e HUD mais detalhados, melhorando a compreensão do jogador.

- O uso de cores, formas e layout foi pensado para reforçar que aspectos do jogo?

O layout reforça a ideia de competição e perigo constante, com elementos de caveira e bombas. As cores vermelho, preto e branco transmitem dinamismo, urgência e reforçam a ideia de perigo, além de se complementaram e se diferenciaram bem no ambiente do jogo.
